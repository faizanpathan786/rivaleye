...
export const reports = pgTable(
  ...
  (t) => [index("reports_owner_id_idx").on(t.owner_id)],
);

export const report_platform_stats = pgTable(
  ...
  (t) => [index("report_platform_stats_report_id_idx").on(t.report_id)],
);

export const report_subreddits = pgTable(
  "report_subreddits",
  {
    id: uuid("id").primaryKey().defaultRandom(),
    report_id: uuid("report_id")
  ...
  (t) => [index("report_subreddits_report_id_idx").on(t.report_id)],
);

export const report_complaints = pgTable(
  "report_complaints",
  {
    id: uuid("id").primaryKey().defaultRandom(),
    report_id: uuid("report_id")
  ...
  (t) => [index("report_complaints_report_id_idx").on(t.report_id)],
);

export const report_feature_gaps = pgTable(
  "report_feature_gaps",
  {
    id: uuid("id").primaryKey().defaultRandom(),
    report_id: uuid("report_id")
  ...
  (t) => [index("report_feature_gaps_report_id_idx").on(t.report_id)],
);

export const report_pricing_tiers = pgTable(
  ...
  (t) => [index("report_pricing_tiers_report_id_idx").on(t.report_id)],
);

export const report_pricing_quotes = pgTable(
  ...
  (t) => [index("report_pricing_quotes_report_id_idx").on(t.report_id)],
);

export const switching_direction_enum = pgEnum("switching_direction", ["inbound", "outbound"]);

export const report_switching = pgTable(
  "report_switching",
  {
    id: uuid("id").primaryKey().defaultRandom(),
    report_id: uuid("report_id")
  ...
  (t) => [index("report_switching_report_id_idx").on(t.report_id)],
);

export const report_quotes = pgTable(
  "report_quotes",
  {
    id: uuid("id").primaryKey().defaultRandom(),
    report_id: uuid("report_id")
  ...
  (t) => [index("report_quotes_report_id_idx").on(t.report_id)],
);

export const voice_word_kind_enum = pgEnum("voice_word_kind", ["positive", "negative"]);

export const report_voice_words = pgTable(
  "report_voice_words",
  {
    id: uuid("id").primaryKey().defaultRandom(),
    report_id: uuid("report_id")
  ...
  (t) => [index("report_voice_words_report_id_idx").on(t.report_id)],
);

export const report_positioning = pgTable(
  "report_positioning",
  {
    id: uuid("id").primaryKey().defaultRandom(),
    report_id: uuid("report_id")
...
export const report_actions = pgTable(
  ...
  (t) => [index("report_actions_report_id_idx").on(t.report_id)],
);

export const report_leads = pgTable(
  "report_leads",
  {
    id: uuid("id").primaryKey().defaultRandom(),
    report_id: uuid("report_id")
  ...
  (t) => [index("report_leads_report_id_idx").on(t.report_id)],
);

export const report_opportunities = pgTable(
  ...
  (t) => [index("report_opportunities_report_id_idx").on(t.report_id)],
);

export const report_threads = pgTable(
  "report_threads",
  {
    id: uuid("id").primaryKey().defaultRandom(),
    report_id: uuid("report_id")
  ...
  (t) => [index("report_threads_report_id_idx").on(t.report_id)],
);

export const report_thread_messages = pgTable(
  ...
  // No report_id column here (parented via thread_id -> report_threads.id);
  // indexed anyway since thread_id is the FK backing report-page joins.
  (t) => [index("report_thread_messages_thread_id_idx").on(t.thread_id)],
);
