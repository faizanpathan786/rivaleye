...
export const opportunityScoreSchema = z.object({
  ...
  factors: z.object({
    pain_frequency: z.number().min(0).default(0).catch(0),
    gap_severity: z.number().min(0).default(0).catch(0),
    switch_intent: z.number().min(0).default(0).catch(0),
    competitor_love_strength: z.number().min(0).default(0).catch(0),
    pricing_pain: z.number().min(0).default(0).catch(0),
    source_confidence: z.number().min(0).default(0).catch(0),
  }).transform(f => ({
...
export const productOpportunityScoreSchema = z.object({
  ...
  explanation: z.string().default(""),
  factors: z.object({
    feature_gap_frequency: zeroToOne.default(0).catch(0),
    pain_severity: zeroToOne.default(0).catch(0),
    source_spread: zeroToOne.default(0).catch(0),
    user_urgency: zeroToOne.default(0).catch(0),
    competitor_love_strength: zeroToOne.default(0).catch(0),
  }).transform(f => ({
...
export const messagingOpportunityScoreSchema = z.object({
  ...
  explanation: z.string().default(""),
  factors: z.object({
    repeated_user_language_strength: z.number().min(0).default(0).catch(0),
    pain_clarity: z.number().min(0).default(0).catch(0),
    promise_reality_gap: z.number().min(0).default(0).catch(0),
    objection_frequency: z.number().min(0).default(0).catch(0),
    quote_quality: z.number().min(0).default(0).catch(0),
    source_confidence: z.number().min(0).default(0).catch(0),
  }).transform(f => ({
...
export const switchIntentScoreSchema = z.object({
  ...
  explanation: z.string().default(""),
  factors: z.object({
    alternative_seeking_posts: z.number().min(0).default(0).catch(0),
    pricing_complaints: z.number().min(0).default(0).catch(0),
    explicit_competitor_frustration: z.number().min(0).default(0).catch(0),
    recency: z.number().min(0).default(0).catch(0),
    engagement_level: z.number().min(0).default(0).catch(0),
    source_quality: z.number().min(0).default(0).catch(0),
  }).transform(f => ({
